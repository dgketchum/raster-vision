...
from rastervision.backend.api import PYTORCH_INSTANCE_SEGMENTATION
...
class PyTorchInstanceSegmentationConfig(SimpleBackendConfig):
    train_opts_class = TrainOptions
    backend_type = PYTORCH_INSTANCE_SEGMENTATION
    backend_class = PyTorchInstanceSegmentation


class PyTorchInstanceSegmentationConfigBuilder(SimpleBackendConfigBuilder):
    config_class = PyTorchInstanceSegmentationConfig

    def _applicable_tasks(self):
        return [rv.INSTANCE_SEGMENTATION]
