...
from rastervision.data.label_source.instance_segmentation_label_source import *
from rastervision.data.label_source.instance_segmentation_label_source_config import *