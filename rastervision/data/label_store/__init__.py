...
from rastervision.data.label_store.instance_segmentation_label_store import *
from rastervision.data.label_store.instance_segmentation_label_store_config import *
