...
class InstanceSegmentationRasterStoreConfig(LabelStoreConfig):
    def __init__(self, uri=None, vector_output=[], rgb=False):
        super().__init__(store_type=rv.INSTANCE_SEGMENTATION_RASTER)
        self.uri = uri
            ...
            if not self.uri:
                ...
                if uri:
                    ...
                    raise rv.ConfigError(
                        'InstanceSegmentationRasterStoreConfig has no '
    ...
    def report_io(self, command_type, io_def):
        ...
        if command_type == rv.EVAL:
            if self.uri:
                ...
                msg = 'No URI set for InstanceSegmentationRasterStoreConfig'
...
class InstanceSegmentationRasterStoreConfigBuilder(LabelStoreConfigBuilder):
    def __init__(self, prev=None):
        ...
        super().__init__(InstanceSegmentationRasterStoreConfig, config)
            ...
            for vo in vector_output:
                if not hasattr(vo, 'mode'):
                    raise rv.ConfigError(
                        ...
                        ' InstanceSegmentationRasterStoreConfig'
