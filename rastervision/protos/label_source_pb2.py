...
_LABELSOURCECONFIG_INSTANCESEGMENTATIONLABELSOURCE = _descriptor.Descriptor(
  name='InstanceSegmentationLabelSource',
  full_name='rv.protos.LabelSourceConfig.InstanceSegmentationLabelSource',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='source', full_name='rv.protos.LabelSourceConfig.InstanceSegmentationLabelSource.source', index=0,
      number=1, type=11, cpp_type=10, label=2,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rgb_class_items', full_name='rv.protos.LabelSourceConfig.InstanceSegmentationLabelSource.rgb_class_items', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LABELSOURCECONFIG_INSTANCESEGMENTATIONRASTERSOURCE = _descriptor.Descriptor(
  name='InstanceSegmentationRasterSource',
  full_name='rv.protos.LabelSourceConfig.InstanceSegmentationRasterSource',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='source', full_name='rv.protos.LabelSourceConfig.InstanceSegmentationRasterSource.source', index=0,
      number=1, type=11, cpp_type=10, label=2,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rgb_class_items', full_name='rv.protos.LabelSourceConfig.InstanceSegmentationRasterSource.rgb_class_items', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LABELSOURCECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='instance_segmentation_raster_source', full_name='rv.protos.LabelSourceConfig.instance_segmentation_raster_source', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='custom_config', full_name='rv.protos.LabelSourceConfig.custom_config', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='object_detection_label_source', full_name='rv.protos.LabelSourceConfig.object_detection_label_source', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='chip_classification_label_source', full_name='rv.protos.LabelSourceConfig.chip_classification_label_source', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='semantic_segmentation_label_source', full_name='rv.protos.LabelSourceConfig.semantic_segmentation_label_source', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='instance_segmentation_label_source', full_name='rv.protos.LabelSourceConfig.instance_segmentation_label_source', index=9,
  ...
  nested_types=[_LABELSOURCECONFIG_OBJECTDETECTIONLABELSOURCE, _LABELSOURCECONFIG_CHIPCLASSIFICATIONLABELSOURCE, _LABELSOURCECONFIG_SEMANTICSEGMENTATIONLABELSOURCE, _LABELSOURCECONFIG_INSTANCESEGMENTATIONLABELSOURCE, _LABELSOURCECONFIG_OBJECTDETECTIONGEOJSONSOURCE, _LABELSOURCECONFIG_CHIPCLASSIFICATIONGEOJSONSOURCE, _LABELSOURCECONFIG_SEMANTICSEGMENTATIONRASTERSOURCE, _LABELSOURCECONFIG_INSTANCESEGMENTATIONRASTERSOURCE, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_LABELSOURCECONFIG_INSTANCESEGMENTATIONLABELSOURCE.fields_by_name['source'].message_type = rastervision_dot_protos_dot_raster__source__pb2._RASTERSOURCECONFIG
_LABELSOURCECONFIG_INSTANCESEGMENTATIONLABELSOURCE.fields_by_name['rgb_class_items'].message_type = rastervision_dot_protos_dot_class__item__pb2._CLASSITEM
_LABELSOURCECONFIG_INSTANCESEGMENTATIONLABELSOURCE.containing_type = _LABELSOURCECONFIG
...
_LABELSOURCECONFIG_INSTANCESEGMENTATIONRASTERSOURCE.fields_by_name['source'].message_type = rastervision_dot_protos_dot_raster__source__pb2._RASTERSOURCECONFIG
_LABELSOURCECONFIG_INSTANCESEGMENTATIONRASTERSOURCE.fields_by_name['rgb_class_items'].message_type = rastervision_dot_protos_dot_class__item__pb2._CLASSITEM
_LABELSOURCECONFIG_INSTANCESEGMENTATIONRASTERSOURCE.containing_type = _LABELSOURCECONFIG
...
_LABELSOURCECONFIG.fields_by_name['instance_segmentation_raster_source'].message_type = _LABELSOURCECONFIG_INSTANCESEGMENTATIONRASTERSOURCE
...
_LABELSOURCECONFIG.fields_by_name['instance_segmentation_label_source'].message_type = _LABELSOURCECONFIG_INSTANCESEGMENTATIONLABELSOURCE
...
_LABELSOURCECONFIG.oneofs_by_name['label_source_config'].fields.append(
  _LABELSOURCECONFIG.fields_by_name['instance_segmentation_raster_source'])
_LABELSOURCECONFIG.fields_by_name['instance_segmentation_raster_source'].containing_oneof = _LABELSOURCECONFIG.oneofs_by_name['label_source_config']
_LABELSOURCECONFIG.oneofs_by_name['label_source_config'].fields.append(
...
_LABELSOURCECONFIG.oneofs_by_name['label_source_config'].fields.append(
  _LABELSOURCECONFIG.fields_by_name['instance_segmentation_label_source'])
_LABELSOURCECONFIG.fields_by_name['instance_segmentation_label_source'].containing_oneof = _LABELSOURCECONFIG.oneofs_by_name['label_source_config']
...
LabelSourceConfig = _reflection.GeneratedProtocolMessageType('LabelSourceConfig', (_message.Message,), dict(
  ...
  InstanceSegmentationLabelSource = _reflection.GeneratedProtocolMessageType('InstanceSegmentationLabelSource', (_message.Message,), dict(
    DESCRIPTOR = _LABELSOURCECONFIG_INSTANCESEGMENTATIONLABELSOURCE,
    __module__ = 'rastervision.protos.label_source_pb2'
    # @@protoc_insertion_point(class_scope:rv.protos.LabelSourceConfig.InstanceSegmentationLabelSource)
    ))
  ,
  ...
  InstanceSegmentationRasterSource = _reflection.GeneratedProtocolMessageType('InstanceSegmentationRasterSource', (_message.Message,), dict(
    DESCRIPTOR = _LABELSOURCECONFIG_INSTANCESEGMENTATIONRASTERSOURCE,
    __module__ = 'rastervision.protos.label_source_pb2'
    # @@protoc_insertion_point(class_scope:rv.protos.LabelSourceConfig.InstanceSegmentationRasterSource)
    ))
  ,
...
_sym_db.RegisterMessage(LabelSourceConfig.InstanceSegmentationLabelSource)
...
_sym_db.RegisterMessage(LabelSourceConfig.InstanceSegmentationRasterSource)
