...
_TASKCONFIG_INSTANCESEGMENTATIONCONFIG_CHIPOPTIONS = _descriptor.Descriptor(
  name='ChipOptions',
  full_name='rv.protos.TaskConfig.InstanceSegmentationConfig.ChipOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='window_method', full_name='rv.protos.TaskConfig.InstanceSegmentationConfig.ChipOptions.window_method', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=_b("random_sample").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='target_classes', full_name='rv.protos.TaskConfig.InstanceSegmentationConfig.ChipOptions.target_classes', index=1,
      number=2, type=5, cpp_type=1, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='debug_chip_probability', full_name='rv.protos.TaskConfig.InstanceSegmentationConfig.ChipOptions.debug_chip_probability', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0.25),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='negative_survival_probability', full_name='rv.protos.TaskConfig.InstanceSegmentationConfig.ChipOptions.negative_survival_probability', index=3,
      number=4, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='chips_per_scene', full_name='rv.protos.TaskConfig.InstanceSegmentationConfig.ChipOptions.chips_per_scene', index=4,
      number=5, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=1000,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='target_count_threshold', full_name='rv.protos.TaskConfig.InstanceSegmentationConfig.ChipOptions.target_count_threshold', index=5,
      number=6, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=2048,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stride', full_name='rv.protos.TaskConfig.InstanceSegmentationConfig.ChipOptions.stride', index=6,
      number=7, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TASKCONFIG_INSTANCESEGMENTATIONCONFIG = _descriptor.Descriptor(
  name='InstanceSegmentationConfig',
  full_name='rv.protos.TaskConfig.InstanceSegmentationConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='class_items', full_name='rv.protos.TaskConfig.InstanceSegmentationConfig.class_items', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='chip_size', full_name='rv.protos.TaskConfig.InstanceSegmentationConfig.chip_size', index=1,
      number=2, type=5, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='chip_options', full_name='rv.protos.TaskConfig.InstanceSegmentationConfig.chip_options', index=2,
      number=3, type=11, cpp_type=10, label=2,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='predict_chip_size', full_name='rv.protos.TaskConfig.InstanceSegmentationConfig.predict_chip_size', index=3,
      number=4, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_TASKCONFIG_INSTANCESEGMENTATIONCONFIG_CHIPOPTIONS, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_TASKCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='instance_segmentation_config', full_name='rv.protos.TaskConfig.instance_segmentation_config', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='custom_config', full_name='rv.protos.TaskConfig.custom_config', index=9,
  ...
  nested_types=[_TASKCONFIG_OBJECTDETECTIONCONFIG, _TASKCONFIG_CHIPCLASSIFICATIONCONFIG, _TASKCONFIG_SEMANTICSEGMENTATIONCONFIG, _TASKCONFIG_INSTANCESEGMENTATIONCONFIG, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_TASKCONFIG_INSTANCESEGMENTATIONCONFIG_CHIPOPTIONS.containing_type = _TASKCONFIG_INSTANCESEGMENTATIONCONFIG
_TASKCONFIG_INSTANCESEGMENTATIONCONFIG.fields_by_name['class_items'].message_type = rastervision_dot_protos_dot_class__item__pb2._CLASSITEM
_TASKCONFIG_INSTANCESEGMENTATIONCONFIG.fields_by_name['chip_options'].message_type = _TASKCONFIG_INSTANCESEGMENTATIONCONFIG_CHIPOPTIONS
_TASKCONFIG_INSTANCESEGMENTATIONCONFIG.containing_type = _TASKCONFIG
...
_TASKCONFIG.fields_by_name['instance_segmentation_config'].message_type = _TASKCONFIG_INSTANCESEGMENTATIONCONFIG
...
_TASKCONFIG.oneofs_by_name['config_type'].fields.append(
  _TASKCONFIG.fields_by_name['instance_segmentation_config'])
_TASKCONFIG.fields_by_name['instance_segmentation_config'].containing_oneof = _TASKCONFIG.oneofs_by_name['config_type']
_TASKCONFIG.oneofs_by_name['config_type'].fields.append(
...
TaskConfig = _reflection.GeneratedProtocolMessageType('TaskConfig', (_message.Message,), dict(
  ...
  InstanceSegmentationConfig = _reflection.GeneratedProtocolMessageType('InstanceSegmentationConfig', (_message.Message,), dict(

    ChipOptions = _reflection.GeneratedProtocolMessageType('ChipOptions', (_message.Message,), dict(
      DESCRIPTOR = _TASKCONFIG_INSTANCESEGMENTATIONCONFIG_CHIPOPTIONS,
      __module__ = 'rastervision.protos.task_pb2'
      # @@protoc_insertion_point(class_scope:rv.protos.TaskConfig.InstanceSegmentationConfig.ChipOptions)
      ))
    ,
    DESCRIPTOR = _TASKCONFIG_INSTANCESEGMENTATIONCONFIG,
    __module__ = 'rastervision.protos.task_pb2'
    # @@protoc_insertion_point(class_scope:rv.protos.TaskConfig.InstanceSegmentationConfig)
    ))
  ,
...
_sym_db.RegisterMessage(TaskConfig.InstanceSegmentationConfig)
_sym_db.RegisterMessage(TaskConfig.InstanceSegmentationConfig.ChipOptions)
