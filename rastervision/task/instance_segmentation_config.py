...
from rastervision.task import InstanceSegmentation
...
class InstanceSegmentationConfig(TaskConfig):
    class ChipOptions:
        def __init__(self,
    ...
    def __init__(self,
                 ...
                 chip_options=None):
        super().__init__(rv.INSTANCE_SEGMENTATION, predict_batch_size,
                         predict_package_uri, debug)
        self.class_map = class_map
        self.chip_size = chip_size
        self.predict_chip_size = predict_chip_size
        if chip_options is None:
            chip_options = InstanceSegmentationConfig.ChipOptions()
    ...
    def create_task(self, backend):
        return InstanceSegmentation(self, backend)
...
class InstanceSegmentationConfigBuilder(TaskConfigBuilder):
    ...
    def with_chip_options(self,
        ...
        b.config['chip_options'] = InstanceSegmentationConfig.ChipOptions(
